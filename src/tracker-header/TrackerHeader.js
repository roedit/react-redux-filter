    ...
    render() {
        return(
            <div className={styles.trackerHeader}>
                <TrackerStatus type="opened" count={this.props.tickets.filter(issue => issue.status === 'opened').length}/>
                <TrackerStatus type="closed" count={this.props.tickets.filter(issue => issue.status === 'closed').length}/>
